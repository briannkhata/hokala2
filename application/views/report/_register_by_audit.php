...
<?php $this->load->view('incs/menu.php'); ?>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Audit No: <?php echo $this->asset_model->get_auditNo($this->uri->segment(3)); ?> Assets</h1>
                </div>
            </div>
                  ...
                  <div class="row">
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <?php echo $this->asset_model->get_auditNo($this->uri->segment(3)); ?> Assets
                                </div>
                                <!-- /.panel-heading -->
 ...
 $(document).on('change', '#centre', function(){
    ...
    function load_data(is_costcentre){
        var dataTable = $('#dtTable').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?php echo base_url('asset/fetch_audit_trans_assets/'.$this->uri->segment(3)); ?>",  
                type:"POST",
           ...
           buttons: [{
               ...
               },
               {
                ...
                title: 'Audit No: <?php echo $this->asset_model->get_auditNo($this->uri->segment(3)); ?> Assets',
                exportOptions: {
