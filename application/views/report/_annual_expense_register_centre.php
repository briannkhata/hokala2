...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header"><?php echo $this->report_model->get_asset_centre_name($cost_centre_id)." Annual Depreciation Expense". " (" . date('Y', strtotime($start_date)) . ")"; ?></h3>
            </div>
        </div>
...
<script type="text/javascript" language="javascript">
    $(document).ready(function() {
        var dataTable = $('#dtTable').DataTable({
            ...
            "order": [],
            "ajax": {
                url: "<?php echo base_url('report/annual_dep_expense_assets_centre'); ?>",
                type: "POST",
                data:{kota_s_date:<?php echo "'$start_date'"?>,kota_e_date:<?php echo "'$end_date'"?>,cost_centre_id:<?php echo $cost_centre_id?>}
            },
            ...
            buttons: [{
                    ...
                    title: '<?php echo $this->report_model->get_asset_centre_name($cost_centre_id)." Annual Depreciation Expense"." (" . date('Y', strtotime($start_date)) . ")".""; ?>',
                    exportOptions: {
